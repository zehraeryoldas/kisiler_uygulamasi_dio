...
import 'package:kisiler_uygulamasi_dio/views/kisiDetay.dart';
import 'package:kisiler_uygulamasi_dio/views/kisiKayit.dart';
                                ...
                                onPressed: () {
                                  ScaffoldMessenger.of(context)
                                    ...
                                    action: SnackBarAction(
                                        ...
                                        onPressed: () {
                                          print("Kişi Sil : ${kisi.kisi_id}");
                                          context.read<AnaSayfaCubit>().kisileriSil(int.parse(kisi.kisi_id));
                                        }),
                                  ));
                                },
                                icon: Icon(Icons.delete_outline))
